	...
	var scheduler = {
	  ...
	  getNextTime: function getNextTime(container) {
	    ...
	    switch (container.schedule.type) {
	      ...
	      case 'recurringSingle':
	        ...
	        ts.add(daysAdded, 'days'); // Set the time of the show date.
	  ...
	  insertVideo: function insertVideo(container) {
	    ...
	    if (videoUrl) {
	      ...
	      template = "<div id=\"la1-video-player\" class=\"containerVideo\" data-embed-id=\"".concat(embedID, "\"></div>");
	      container.insertAdjacentHTML('afterbegin', template);
	      scheduler.insertScript('https://control.livingasone.com/webplayer/loader.min.js'); // @ts-ignore
