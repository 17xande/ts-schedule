	...
	var scheduler = {
	  ...
	  getContainers: function getContainers(selector) {
	    ...
	    for (var i = 0; i < divs.length; i++) {
	      var _div$dataset$chatUrl, _div$dataset$chatRoom, _div$dataset$videoUrl, _div$dataset$clockend, _div$dataset$sheetLoo, _div$dataset$embedId, _div$dataset$show, _div$dataset$hide, _div$dataset$showHide, _div$dataset$timezone;
	      ...
	      var sheetLookup = (_div$dataset$sheetLoo = div.dataset.sheetLookup) !== null && _div$dataset$sheetLoo !== void 0 ? _div$dataset$sheetLoo : '';
	      var _container = {
	        div: div,
...
//# sourceMappingURL=ts-schedule.browser.0.5.0.js.map
